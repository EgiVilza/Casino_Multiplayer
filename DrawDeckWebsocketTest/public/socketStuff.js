...
var btn = document.getElementById('drawCard')
...
btn.addEventListener('click', function(){
  socket.emit('drawCard', {
   ...
   drawnCard: testDeck.cards.pop(),
   cardsRemaining: testDeck.cards,
...
socket.on('drawCard', function(data){
    testDeck.cards = data.cardsRemaining
    currentCard.innerHTML += '<li>' + data.drawnCard.rank + ' ' + data.drawnCard.suit + '. There are ' + testDeck.cards.length + ' remaining. </li>' ;
});
